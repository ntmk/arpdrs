...
namespace HoloToolkit.Unity.UX
{
    ...
    public class BoundingBoxRig : MonoBehaviour
    {
        ...
        // Was 0.7f set to 0 to see if scale boxes are hidden
        private Vector3 scaleHandleSize = new Vector3(0.0f, 0.0f, 0.0f);
        ...
        private void Start()
        {
            ...
            boxInstance.transform.parent = boxInstance.Target.transform.parent;

            BuildRig().transform.parent = boxInstance.Target.transform.parent;

            appBarInstance = Instantiate(appBarPrefab) as AppBar;
            appBarInstance.BoundingBox = boxInstance;

            appBarInstance.transform.parent = boxInstance.Target.transform.parent;
